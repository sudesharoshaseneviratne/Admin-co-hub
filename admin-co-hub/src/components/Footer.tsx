...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-br from-gray-900 to-black text-white py-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <AnimatedSection animation="fadeInUp" delay={100}>
            <h3 className="text-base font-semibold mb-3 text-teal-400">Services</h3>
          ...
          <AnimatedSection animation="fadeInUp" delay={200}>
            <h3 className="text-base font-semibold mb-3 text-emerald-400">Company</h3>
            <ul className="space-y-1 text-gray-400 text-sm">
          ...
          <AnimatedSection animation="fadeInRight" delay={300}>
            <h3 className="text-base font-semibold mb-3 text-amber-400">Contact</h3>
            <ul className="space-y-2 text-gray-400 text-sm">
              <li className="flex items-center hover:text-white transition-colors cursor-pointer group">
                <div className="w-4 h-4 mr-2 flex-shrink-0">
                  <svg className="w-4 h-4 text-amber-400 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <AnimatedSection animation="fadeInUp" delay={100}>
            <h3 className="text-base font-semibold mb-3 text-blue-400">Services</h3>
          ...
          <AnimatedSection animation="fadeInUp" delay={200}>
            <h3 className="text-base font-semibold mb-3 text-green-400">Company</h3>
            <ul className="space-y-1 text-gray-400 text-sm">
          ...
          <AnimatedSection animation="fadeInRight" delay={300}>
            <h3 className="text-base font-semibold mb-3 text-purple-400">Contact</h3>

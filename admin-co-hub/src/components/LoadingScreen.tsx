      ...
      <div className="relative z-10 text-center">
        ...
        <div className="relative mb-6">
          <div className="w-20 h-20 mx-auto mb-6 relative">
            <div className="absolute inset-0 bg-teal-600/20 rounded-full animate-ping"></div>
            <div className="absolute inset-2 bg-teal-600/40 rounded-full animate-pulse"></div>

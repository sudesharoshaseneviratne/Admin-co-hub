  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-teal-50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <AnimatedSection animation="fadeInUp" className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4 bg-gradient-to-r from-gray-900 to-teal-600 bg-clip-text text-transparent">
          ...
          <div className="space-y-16">
            ...
            <AnimatedSection animation="fadeInRight" className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 bg-white rounded-xl p-8 shadow-lg border border-emerald-100">
                <div className="text-center">
                  ...
                  <div className="text-3xl font-bold text-emerald-600 mb-2">1-2 Weeks</div>
            ...
            <AnimatedSection animation="fadeInLeft" className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg border border-amber-100">
                <div className="text-center">
                  ...
                  <div className="text-3xl font-bold text-amber-600 mb-2">2-4 Weeks</div>

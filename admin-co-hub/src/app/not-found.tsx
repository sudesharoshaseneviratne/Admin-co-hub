      ...
      <div className="pt-32 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link 
              href="/contact" 
              className="border-2 border-blue-600 text-blue-600 px-8 py-4 rounded-lg hover:bg-blue-600 hover:text-white transition-colors text-lg font-semibold"
            >
              Contact Us
            </Link>
          </div>
          ...
          <div className="mt-12 p-8 bg-gray-50 rounded-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <Link href="/testimonials" className="text-blue-600 hover:text-blue-700 font-medium">
                Success Stories
              </Link>
            </div>
          </div>

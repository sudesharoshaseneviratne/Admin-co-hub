      ...
      <section className="pt-25">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            {/* Contact Information */}
            <div>
              <h2 className="text-3xl font-bold text-teal-600 mb-8">Get In Touch</h2>
              ...
              <div className="space-y-8">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-teal-600 mb-1">Phone</h3>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-teal-600 mb-1">Email</h3>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-teal-600 mb-1">Office</h3>
            ...
            <div>
              <div className="bg-white rounded-2xl shadow-lg p-8">
                <h2 className="text-2xl font-bold text-teal-600 mb-6">Send Us a Message</h2>
                <ContactForm />
              </div>
            </div>
          </div>
